...
function Dashboard() {
  ...
  const { links, fetchLinks, deleteLink } = useLinkStore();
  ...
  }, [authUser, fetchNotes, fetchLinks]);
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-7xl mx-auto p-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {/* Quick Actions and Recent Links */}
              ...
              <div className="bg-gray-800 rounded-xl border border-gray-700 p-6">
                ...
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full flex items-center gap-3 p-4 bg-gray-700 hover:bg-gray-600 rounded-lg border border-gray-600 hover:border-purple-500 transition-all duration-200 group"
                  >
                    <div className="p-2 bg-purple-500/10 rounded-lg">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-purple-400 group-hover:text-purple-300" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M12.586 4.586a2 2 0 112.828 2.828l-3 3a2 2 0 01-2.828 0 1 1 0 00-1.414 1.414 4 4 0 005.656 0l3-3a4 4 0 00-5.656-5.656l-1.5 1.5a1 1 0 101.414 1.414l1.5-1.5zm-5 5a2 2 0 012.828 0 1 1 0 101.414-1.414 4 4 0 00-5.656 0l-3 3a4 4 0 105.656 5.656l1.5-1.5a1 1 0 10-1.414-1.414l-1.5 1.5a2 2 0 11-2.828-2.828l3-3z" clipRule="evenodd" />
                      </svg>
                    </div>
                    <div className="text-left">
                      <p className="text-white font-medium">New Link</p>
                      <p className="text-gray-400 text-sm">Save a new link</p>
                    </div>
                  </button>
                    ...
                    {recentLinks.map((link) => (
                      <div key={link._id} className="group">
                        <a
                          ...
                          className="flex items-start gap-3 p-3 bg-gray-700 hover:bg-gray-600 rounded-lg border border-gray-600 hover:border-purple-500 transition-all duration-200"
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            <p className="text-white font-medium text-sm truncate group-hover:text-purple-300 transition-colors duration-200">
                              {link.title}
                            </p>
                            {link.description && (
                          ...
                          <button
                            ...
                            className="flex-shrink-0 opacity-0 group-hover:opacity-100 p-1.5 text-red-400 hover:text-red-300 hover:bg-gray-700 rounded transition-all duration-200"
                            title="Delete link"
                          >
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                              <path fillRule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clipRule="evenodd" />
